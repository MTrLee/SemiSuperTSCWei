...
class net_para():
    def __init__(self):
        ...
        self.model_save_pos = ""
        self.data_path = os.getcwd() + "/../UCRArchive_2018"
        self.onerun_suffix = ""
        #     self.res_file_name=""
        self.res_save_dir = ""
        ...
        self.net_type = "os.getcwd()+'/../result/"
        self.run_times = "tmp"
        self.batch_size = 30
    ...
    def set_save_dirs(self):
        ...
        # if train_env == 'colab':
        #     # 运行环境为线上时的配置
        #     data_path = os.getcwd() + '/drive/MyDrive/Datasets/UCRArchive_2018'
        ...
        # self.res_save_dir = os.getcwd() + '/../result/' + self.net_type + '/' + self.test_type + '_' + self.run_times + '/'
